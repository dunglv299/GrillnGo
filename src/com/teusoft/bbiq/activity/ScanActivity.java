...
public class ScanActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// MainActivity.EXTRAS_DEVICE_NAME);
		// mDeviceAddress = getIntent().getStringExtra(
		// MainActivity.EXTRAS_DEVICE_ADDRESS);
		// isConnected = getIntent().getExtras().getBoolean("status");
	...
	private class LeDeviceListAdapter extends BaseAdapter {
		...
		public View getView(int i, View view, ViewGroup viewGroup) {
			...
			if (view == null) {
				...
				viewHolder.deviceConnected = (TextView) view
						.findViewById(R.id.device_connect);
			...
			final String deviceName = "BBiQ " + (i + 1);
			...
			// if (i == 0 && isConnected) {
			// viewHolder.deviceConnected.setText(R.string.connected);
			// } else {
			// viewHolder.deviceConnected.setText("");
			// }
			return view;
		}
	}
