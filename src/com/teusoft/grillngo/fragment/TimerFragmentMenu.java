...
public class TimerFragmentMenu extends BaseFragment implements View.OnClickListener {
    ...
    protected void initView(View view) {
        ...
        timerBtn = (Button) view.findViewById(R.id.start_btn);
        textView = (TextView) view.findViewById(R.id.textView);
        mTimePickerLayout = (LinearLayout) view
                .findViewById(R.id.layout_time_picker);
        mCountDownLayout = (LinearLayout) view.findViewById(R.id.layout_countdown);
    ...
    public static void showNotification(Context context, String message,
        ...
        Notification mNotification = new Notification.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_bbiq_launcher)
